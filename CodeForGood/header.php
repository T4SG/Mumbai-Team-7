<div class="header" style="height:70px;border:0px solid;">
	<div class="logo" style="width:auto;height:auto;border-left:50px solid;float:left;">
		</div>
	<div class="menu" style="float:left;height:auto;margin-top:17px;width:auto;border:0px solid;font-family: MyWebFont;font-size: 24px;color:white;vertical-align:bottom">
		<ul class="menu1">
